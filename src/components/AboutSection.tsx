          ...
          <div className="grid sm:grid-cols-2 gap-6">
            {pillars.map((p, i) => (
              <motion.div
                ...
                className="border border-border p-6 hover:border-primary/40 transition-colors group"
              >
                <p.icon className="w-8 h-8 text-primary mb-4 group-hover:scale-110 transition-transform" />
